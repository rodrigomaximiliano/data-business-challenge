...
1. Who are our customers and how do they behave?
2. Can we segment them into actionable groups?
3. Can we predict who will respond to the next campaign to make it profitable?
4. How do we translate data insights into creative and budget decisions?
...
### 2️⃣ Segmentation using K-Means (k=4)
...
### 3️⃣ Predictive Model — Random Forest

A `RandomForestClassifier` was trained with `class_weight='balanced'` to predict customer response probability.
...
| Element | Champions | High Value | Recently Active | Dormant |
|----------|------------|------------|-----------------|----------|
| **Concept** | Exclusivity / Premium | Perceived value | Frequency / Habit | — |
| **Trigger** | Accepted 2+ past campaigns | High income, low conversion | Frequent buyer, low ticket | ROAS 0.16 |
...
- 🟡 **High Value** → Optimize creative. They have purchasing power but current messaging underperforms.
...
Data-driven targeting turns marketing from cost center into a profit engine.
